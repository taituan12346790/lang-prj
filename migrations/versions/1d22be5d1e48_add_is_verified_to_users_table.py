...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_exercise_results_created_at'), table_name='exercise_results')
    op.drop_index(op.f('ix_exercise_results_exercise_type'), table_name='exercise_results')
    op.drop_index(op.f('ix_exercise_results_session_id'), table_name='exercise_results')
    op.drop_index(op.f('ix_exercise_results_skill_tag'), table_name='exercise_results')
    op.drop_index(op.f('ix_exercise_results_user_id'), table_name='exercise_results')
    op.drop_index(op.f('ix_exercise_session_created'), table_name='exercise_results')
    op.drop_index(op.f('ix_exercise_user_created'), table_name='exercise_results')
    op.drop_index(op.f('ix_exercise_user_skill'), table_name='exercise_results')
    ...
    op.drop_index(op.f('idx_session_created'), table_name='conversations')
    ...
    op.drop_index(op.f('ix_memory_entries_skill_name'), table_name='memory_entries')
    op.drop_index(op.f('ix_memory_entries_skill_type'), table_name='memory_entries')
